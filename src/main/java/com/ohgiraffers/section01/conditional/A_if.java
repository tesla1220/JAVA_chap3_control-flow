...
public class A_if {
    ...
    public void testSimpleIfStatement() {
        ...
        *   */
        ...
        /* 필기.
        *   정수 한 개를 입력 받아 그 수가 짜굿이면 "입력하신 숫자는 짝수입니다."
        ...
        *  */
        ...
        Scanner sc = new Scanner(System.in);        //Scanner 받아오는 공식으므로 통으로 외울 것!!!
    ...
    public void testNestedIfStatement() {
        ...
        /* 수업목표. 중첩된 if문의 흐름을 이해하고 적용할 수 있따. */
        /* 필기. 중첩된 if문 실행 흐름 확인 */
