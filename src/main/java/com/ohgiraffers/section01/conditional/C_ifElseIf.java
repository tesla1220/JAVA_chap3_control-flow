...
public class C_ifElseIf {
    ...
    public void testSimpleIfElseIfStatement() {
         ...
         *   조건식1과 조건식2의 결과 값이 모두 거짓(false)이면 else { } 안에 있는 모드 실행.
         *   */

        // if-else-if문은 여러 개의 조건을 제시하여 그 중 한 가지를 반드시 실행시키고 싶은 경우 사용한다.

        System.out.println("산 속에서 나무를 하던 나뭇꾼이 연못에 도끼를 빠드렸다....");
        System.out.println("나뭇꾼이 어쩔 줄 몰라하던 그 대....");
        ...
        if (answer == 1) {
            ...
            System.out.println("오~~ 정직한 놈이로구나..");
        }
